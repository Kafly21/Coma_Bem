...
const List<RestauranteModel> demoRestaurants = <RestauranteModel>[
  RestauranteModel(
    ...
    descricao:
        'Hambúrgueres artesanais, batatas crocantes e combinações premium para qualquer momento.',
    bannerImage:
    ...
    pratos: <PratoModel>[
      PratoModel(
        ...
        descricao:
            'Pão brioche, duas carnes suculentas, bacon crocante e molho especial.',
        preco: 34.90,
        imageUrl:
  ...
  RestauranteModel(
    ...
    descricao:
        'Sushi fresco, sashimi e combinações especiais para todos os gostos.',
    bannerImage:
