...
class CampoFormularioCustomizado extends StatelessWidget {
  ...
  // 'final' significa que esses valores não mudarão depois que o widget for construído.
  final String titulo;
  ...
  Widget build(BuildContext context) {
    // Retornamos a estrutura visual de um TextField com margem inferior (Padding).
    return Padding(
      padding: const EdgeInsets.only(bottom: 15.0),
      child: TextField(
        controller: controlador, // Recebe o controlador que veio de fora
        keyboardType:
            tipoTeclado, // Define se abre o teclado de letras ou números
